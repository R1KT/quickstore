document.addEventListener('DOMContentLoaded', () => {
    ...
    // Define paths to external HTML files and their corresponding CSS
    const contentMap = {
        residentContent: {
            html: '/static/residents.html',
            css: '/static/residents.css'
        },
        dashboardContent: {
        ...
        servicesContent: {
            html: '/static/services.html',
            css: '/static/services.css'
        }
    };
